...
public class MyProfilePage {
    ...
    private final Radio everyDay = new Radio(By.xpath("//*[@id='mmb-newsletter-component-options']//input[@data-selenium='mmb-newsletter-component-daily-radio']"));
    private final Radio twoTimesAWeek = new Radio(By.xpath("//*[@id='mmb-newsletter-component-options']//input[@data-selenium='mmb-newsletter-component-twice-weekly-radio']"));
    private final Radio everyWeek = new Radio(By.xpath("//*[@id='mmb-newsletter-component-options']//input[@data-selenium='mmb-newsletter-component-weekly-radio']"));
    private final Radio never = new Radio(By.xpath("//*[@id='mmb-newsletter-component-options']//input[@data-selenium=mmb-'newsletter-component-never-radio']"));
    private final Checkbox bookingReminders = new Checkbox(By.xpath("//*[@id='mmb-reminders-component']//*[@class='toggle-handle btn btn-default']"));
    private final Checkbox messagesAboutPromotions = new Checkbox(By.xpath("//*[@id='mmb-promotions-component']//*[@class='toggle-handle btn btn-default']"));
    private final Checkbox informationAboutOffers = new Checkbox(By.xpath("//*[@class='mmb-amp-offers-component mmb-component']//*[@class='toggle-handle btn btn-default']"));
